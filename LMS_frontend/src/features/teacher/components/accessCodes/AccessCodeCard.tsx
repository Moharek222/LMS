      ...
      <div className="space-y-3 w-full md:w-auto">
        <div className="flex items-center gap-3 flex-wrap">
          <div className="px-4 py-2 rounded-2xl bg-teal-50/90 text-[#0D8A82] border-2 border-teal-200/90 flex items-center gap-2.5 font-mono font-black text-base sm:text-lg tracking-widest shadow-2xs select-all">
            <KeyRound size={20} className="shrink-0 text-[#0D8A82]" />
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white text-slate-700 hover:bg-slate-100 border border-slate-200/90 text-xs font-bold transition cursor-pointer shadow-2xs"
            title="نسخ الكود"
          >
            {copied ? (
              <>
