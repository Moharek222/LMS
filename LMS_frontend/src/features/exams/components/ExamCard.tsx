    ...
    <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-5">
      ...
      <div className="pt-2 border-t border-slate-100">
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#0D8A82] text-white text-xs font-bold hover:bg-teal-700 active:scale-[0.99] transition cursor-pointer shadow-xs"
        >
